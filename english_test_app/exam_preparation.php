    ...
    <div class="container">
        ...
        <div id="questions-container">
            ...
            <div class="question" id="question2">
                ...
                <label><input type="radio" name="q2" value="A"> Can you say that again, please?</label>
                <label><input type="radio" name="q2" value="B"> What do you want?</label>
                <label><input type="radio" name="q2" value="C"> Tell me more.</label>
            </div>
            ...
            <div class="question" id="question8">
                ...
                <label><input type="radio" name="q8" value="A"> Sorry, could you repeat that please?</label>
                <label><input type="radio" name="q8" value="B"> Tell me again.</label>
            ...
            <div class="question" id="question10">
                ...
                <label><input type="radio" name="q10" value="A"> Take care!</label>
                <label><input type="radio" name="q10" value="B"> I need to talk to you.</label>
            ...
            <div class="question" id="question12">
                ...
                <label><input type="radio" name="q12" value="A"> Why don’t we go for a walk?</label>
                <label><input type="radio" name="q12" value="B"> Let’s watch TV.</label>
                <label><input type="radio" name="q12" value="C"> How are you feeling?</label>
            </div>

            <!-- Вопрос 13 -->
            <div class="question" id="question13">
                <h3>13. How would you express that you don't know something?</h3>
                <label><input type="radio" name="q13" value="A"> I’m not sure about that.</label>
                <label><input type="radio" name="q13" value="B"> I don’t have time.</label>
            ...
            <div class="question" id="question14">
                ...
                <label><input type="radio" name="q14" value="A"> What are your plans for tonight?</label>
                <label><input type="radio" name="q14" value="B"> Where are you going?</label>
            ...
            <div class="question" id="question16">
                ...
                <label><input type="radio" name="q16" value="A"> What do you do in your free time?</label>
                <label><input type="radio" name="q16" value="B"> What time is it?</label>
                <label><input type="radio" name="q16" value="C"> Can I join you?</label>
            </div>

            <!-- Вопрос 17 -->
            <div class="question" id="question17">
                <h3>17. How would you apologize for being late?</h3>
                <label><input type="radio" name="q17" value="A"> Sorry I’m late.</label>
                <label><input type="radio" name="q17" value="B"> I didn’t want to come.</label>
                <label><input type="radio" name="q17" value="C"> What are you doing?</label>
            </div>

            <!-- Вопрос 18 -->
            <div class="question" id="question18">
                <h3>18. How would you show you don’t understand?</h3>
                <label><input type="radio" name="q18" value="A"> I don’t understand.</label>
                <label><input type="radio" name="q18" value="B"> I know everything.</label>
            ...
            <div class="question" id="question19">
                ...
                <label><input type="radio" name="q19" value="A"> Could you repeat your number, please?</label>
                <label><input type="radio" name="q19" value="B"> What is your number?</label>
