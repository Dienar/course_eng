    ...
    <div class="container">
        ...
        <div id="questions-container">
            ...
            <div class="question" id="question1">
                <h3>1. Choose the correct phrasal verb:</h3>
            ...
            <div class="question" id="question2">
                <h3>2. Choose the correct idiom:</h3>
                <p>He was so nervous that he was _____.</p>
            ...
            <div class="question" id="question3">
                <h3>3. Choose the correct modal verb:</h3>
            ...
            <div class="question" id="question4">
                <h3>4. Choose the correct conditional sentence:</h3>
            ...
            <div class="question" id="question5">
                <h3>5. Choose the correct reported speech:</h3>
            ...
            <div class="question" id="question6">
                <h3>6. Choose the correct passive voice:</h3>
            ...
            <div class="question" id="question7">
                <h3>7. Choose the correct article:</h3>
            ...
            <div class="question" id="question8">
                <h3>8. Choose the correct comparative form:</h3>
            ...
            <div class="question" id="question9">
                <h3>9. Choose the correct superlative form:</h3>
            ...
            <div class="question" id="question14">
                <h3>14. Choose the correct collocation:</h3>
                <p>She _____ a great effort to finish the project on time.</p>
            ...
            <div class="question" id="question15">
                <h3>15. Choose the correct expression:</h3>
                <p>He _____ his mind at the last minute.</p>
            ...
            <div class="question" id="question16">
                <h3>16. Choose the correct tense:</h3>
                <p>By the time we arrived, the movie _____.</p>
            ...
            <div class="question" id="question17">
                <h3>17. Choose the correct expression:</h3>
                <p>She _____ her temper during the meeting.</p>
            ...
            <div class="question" id="question18">
                <h3>18. Choose the correct expression:</h3>
                <p>He _____ his promise to help her.</p>
            ...
            <div class="question" id="question19">
                <h3>19. Choose the correct expression:</h3>
                <p>She _____ her mind about the trip.</p>
            ...
            <div class="question" id="question20">
                <h3>20. Choose the correct expression:</h3>
                <p>He _____ his temper during the argument.</p>
